    ...
    <div className="space-y-3">
      ...
      {hasMeals && (
        <div className="bg-card border-2 border-border rounded-2xl p-4 space-y-2">
          <p className="text-muted text-xs font-black uppercase tracking-wider mb-1">By Meal</p>
          {log!.meals_json.map((m) => (
            <div key={m.meal} className="flex items-center justify-between py-1.5 border-b border-border last:border-0">
